...
// More headers
$headers .= 'From: Iwin Web Formular <iwin.formular@jmurin.sk>' . "\r\n";
...
$transport = Swift_SmtpTransport::newInstance('smtp.jmurin.sk', 25)
        ->setUsername('iwin.formular@jmurin.sk')
        ->setPassword('qsHHaXspxA')
;
...
$message = Swift_Message::newInstance('Nove inzeraty')
        ->setFrom(array('iwin.formular@jmurin.sk' => 'Iwin Web Formular'))
        ->setTo(array('janmurin2@gmail.com'))
        ->setSubject('Iwin web formular')
